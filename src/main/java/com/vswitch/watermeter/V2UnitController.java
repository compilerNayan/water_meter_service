...
@RestController
public class V2UnitController {

    private final UnitService unitService;
    private final UserService userService;

    V2UnitController(UnitService unitService, UserService userService) {
        this.unitService = unitService;
        this.userService = userService;
    }

    @GetMapping("/v2/tenants/{tenantId}/units")
    ...
    @PostMapping("/v2/tenants/{tenantId}/units")
    ...
    @GetMapping("/v2/tenants/{tenantId}/devices/{deviceId}/enrollment-status")
